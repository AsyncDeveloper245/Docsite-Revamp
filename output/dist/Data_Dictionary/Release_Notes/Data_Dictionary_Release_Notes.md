...
- Add one new enum to `library_strategy` <!--DAT-2793-->
  - `scRNA-Seq`
- **structural_variation entity** <!--DAT-2703-->
...
- Added new enum to `days_to_follow_up`
  - `null`
- **molecular_test entity** <!--DAT-2741-->
...
- Modified `diagnosis` entity
  ...
  - Migrated values not part of permissible values to `Not Reported` for following properties - `primary_diagnosis` <!--DAT-2412--> - `site_of_resection_or_biopsy` <!--DAT-2413 --> - `tumor_grade` <!--DAT-2414--> - `tissue_or_organ_of_origin` <!--DAT-2438-->
  - Removed permissible values from - `tissue_or_organ_of_origin` <!--DAT-2426--> - `morphology` <!--  DAT-2427-->
